...
| 11 | [Secure RAG](11_security_authorization.ipynb) | Tenant isolation, untrusted content, prompt injection, and policy traces | Deterministic Python controls; maps to policy/identity layers |
