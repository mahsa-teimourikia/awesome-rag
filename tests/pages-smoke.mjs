...
if (!bundle.includes("Build answers") || !bundle.includes("FIELD GUIDE") || !bundle.includes("Corrective RAG") || !bundle.includes("Adaptive RAG") || !bundle.includes("Enterprise RAG Platform Capstone") || !bundle.includes("HyDE retrieval")) throw new Error("Pages bundle is missing current Field Guide learning content");
