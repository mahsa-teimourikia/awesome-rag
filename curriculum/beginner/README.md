...
Prerequisites: basic Python and command-line usage. Start with [What is RAG?](../../docs/what-is-rag.md), then complete [RAG foundations](01-rag-foundations/README.md), [the first local baseline](02-first-local-rag/README.md), [the chunking lab](03-chunking-lab/README.md), and [citations and abstention](04-citations-abstention/README.md). Refer to [technology decisions](../../docs/technology-decisions.md) only after you can explain the dependency-free baseline.
